Practice Programming Assignment: Интеграция структуры Point в unordered_set
...
В своей реализации используйте стандартную хеш-функцию std::hash<CoordType> для хеширования координат 
и комбинируйте полученные хеши с помощью полинома, как показано в лекции.  
...
Заготовка решения: hash_point.cpp
